...
public class GeneralUtilities extends Base{
	...
	public void scrollDownUsingJavaScriptExecutor()
	{
		JavascriptExecutor js = (JavascriptExecutor)driver;// casting instance of webDriver instance into the JavascriptExecutor interface to use the class methods 
	...
	public void simpleAlertAccept(WebElement element)
	{
		element.click();
		driver.switchTo().alert().accept();
	}
	
	public void confirmationAlertAccept(WebElement element)
	{
		element.click();
		driver.switchTo().alert().accept();
	}
	
	public void confirmationAlertDismiss(WebElement element)
	{
		element.click();
		driver.switchTo().alert().dismiss();
	}
	public void promptAlertAccept(WebElement element)
	{
		element.click();
		driver.switchTo().alert().dismiss();
	}
	public String promptAlertgetText(WebElement element,String inputString)
	{
	...
	public void promptAlertDismiss(WebElement element)
	{
		element.click();
		driver.switchTo().alert().dismiss();
	}
